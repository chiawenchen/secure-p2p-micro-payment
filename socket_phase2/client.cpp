    ...
    while(true){
        ...
        switch(num1){
            ...
            case 1:
            {
                ...
                send(socket_d, sendToServerMessage.c_str(), sendToServerMessage.length(), 0);
                recv(socket_d, recvMessage, sizeof(recvMessage), 0);
                cout << recvMessage;
                break;
            }
                            ...
                            switch (num2){
                                ...
                                {  
                                  ...
                                  //  cout << "TWO" << endl;
                                    ...
                                    sock_toPeer_info.sin_addr.s_addr = inet_addr("127.0.0.1"); //"127.0.0.1" peerIP.c_str()
                                    sock_toPeer_info.sin_port = htons(atoi(peerPort.c_str()));
                                    cout << "peer ip: " << peerIP << " " << "peer port: " << peerPort << endl;
                                    // establish a connection
